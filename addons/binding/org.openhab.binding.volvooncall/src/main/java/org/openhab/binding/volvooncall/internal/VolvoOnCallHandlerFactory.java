...
import org.openhab.binding.volvooncall.handler.VehicleHandler;
...
public class VolvoOnCallHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(VEHICLE_THING_TYPE)) {
    ...
    private void unregisterDeviceDiscoveryService(ThingUID thingUID) {
        if (discoveryServiceRegs.containsKey(thingUID)) {
            ...
            VolvoOnCallDiscoveryService service = (VolvoOnCallDiscoveryService) bundleContext
